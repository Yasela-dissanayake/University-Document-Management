...
//         string program;
//         uint8 year;
//         string documentsIPFSHash; // REMOVE THIS LINE
//         bytes32 contentHash;
//         uint256 timestamp;
//         bool isActive;
//         address studentWallet;
//         // ADD BELOW:
//         string[] semesterHashes; // Each semester's transcript or grades IPFS hash
//         bytes32[] contentHashes; // Each semester's content hash for integrity
//         uint256[] timestamps; // Record when each update was added
//     }
...
//         students[_studentId] = StudentRecord({
//             studentId: _studentId,
//             name: _name,
//             program: _program,
//             year: _year,
//             documentsIPFSHash: _documentsIPFSHash,
//             contentHash: _contentHash,
//             timestamp: block.timestamp,
//             isActive: true,
//             studentWallet: _studentWallet,
//             semesterHashes: new string[](0),
...
//         // Linked list logic (adapted from your vehicle registry)
//         if (studentCount == 0) {
//             head = _studentId;
//             tail = _studentId;
//         } else {
...
//         )
//     {
//         StudentRecord memory student = students[_studentId];
//         return (
//             student.studentId,
//             student.name,
//             student.program,
//             student.year,
//             student.documentsIPFSHash,
//             student.contentHash,
//             student.timestamp,
//             student.isActive
//         );
...
//     // Append new semester document for an existing student
//     function addSemesterRecord(
//         string memory _studentId,
//         string memory _ipfsHash,
//         bytes32 _contentHash
//     ) public onlyAuthorized studentExists(_studentId) {
//         StudentRecord storage student = students[_studentId];
//         student.semesterHashes.push(_ipfsHash);
//         student.contentHashes.push(_contentHash);
//         student.timestamps.push(block.timestamp);
...
//             msg.sender
//         );
//         // Optionally update the "latest" field for convenience:
//         student.documentsIPFSHash = _ipfsHash;
//         student.contentHash = _contentHash;
//         student.timestamp = block.timestamp;
//     }

//     // Retrieve all semester hashes for a student
